        ...
        return new Promise ( (resolve, reject) => {
            ...
            .then ( pallets => {
                if ( that.isPalletExist ( pallets, userPallet ) ) {
                    reject ( 'Palette already existed' );
                }else if(that.isSamePalletName(pallets, userPallet)){
                    reject ( 'Palette Name already existed' );
                }else if(that.isColorExist(userPallet) ){
                    reject ( 'Colors is existed in this palette' );
                }else {
                    ...
                    .then (() => {
                        ...
                        .then ( data => {
                            resolve ( "Add new palette successful" );
                        },
                        error => {
                            resolve ( "Add new palette fail" );
                        });
                    });
                }
            });
